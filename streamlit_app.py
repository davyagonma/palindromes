...
from simulators import palindrome, unary_add, unary_sub, unary_mul, unary_div

st.set_page_config(page_title="MT - Palindromes & Calculs", layout="centered")
st.title("🧠 Machine de Turing – Exercice 7")
